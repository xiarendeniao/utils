...
createctags "server" tags

createctags "include server libsrc" tags2

createctags "include server libsrc tools" tags3

createctags "include server libsrc tools" tags4 "--c-types=+px"

createctags "include server libsrc tools ext" tags5 "--c-types=+px"

createctags "include server libsrc ../server_thirdparty_proj/behaviac-3.5.7/" aitags "--c-types=+px"

createluatags "dataconfig/lua server/lua_conn server/lua_crontab server/lua_script"  luatags
